  	...
  	<div class="row row-sm">
  		<div class="col-sm-6 col-xl-6 col-md-6">
  			<div class="az-content-breadcrumb">
				...
				<span><?php echo $arrLang[$defaultLanguage]['transaction_finance_revenue']; ?></span>
			</div>
			<h2 class="az-content-title"><?php echo $arrLang[$defaultLanguage]['transaction_finance_revenue']; ?></h2>
		...
		<div class="col-sm-6 col-xl-6 col-md-6">
			<div style="text-align: right; float: right; display: flex;">
				<button data-bind="visible: trfrev.buttonVisible, click: trfrev.addTransaction" id="add" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo $arrLang[$defaultLanguage]['add_transaction']; ?></button>&nbsp;
				<button data-bind="visible: trfrev.buttonUnVisible, click: trfrev.titleNew() ? trfrev.saveTransaction : trfrev.saveUpdateTransaction" id="save" class="btn btn-success"><i class="fa fa-floppy-o"></i> 
					<span data-bind="visible: trfrev.titleNew"><?php echo $arrLang[$defaultLanguage]['save']; ?></span>
					<span data-bind="visible: trfrev.titleEdit"><?php echo $arrLang[$defaultLanguage]['update']; ?></span>
				</button>&nbsp;
				<button data-bind="visible: trfrev.buttonUnVisible, click: trfrev.cancelTransaction" id="cancel" class="btn btn-danger"><i class="fa fa-times"></i> <?php echo $arrLang[$defaultLanguage]['cancel']; ?></button>
			</div>
		</div>
	</div>
	<div class="row row-sm">
		<div data-bind="visible: trfrev.loader" class="col-sm-12 col-xl-12">
		...
		<div id="transaction-finance" data-bind="visible: trfrev.form" class="col-sm-12">
			<div class="card">
				<!-- <div class="card card-header">
					<nav class="nav nav-pills">
						<a class="nav-link active show" data-toggle="tab" href="#" onclick="trfrev.changeMode('single')">
							<?php echo $arrLang[$defaultLanguage]['single']; ?>
						</a>
						<a class="nav-link" data-toggle="tab" href="#" onclick="trfrev.changeMode('multiple')">
				...
				<div class="card card-body pd-30 pd-sm-40">
					...
					<div data-bind="visible: trfrev.modeSingle">
						...
						<form id="forminputdetails" class="row">
							...
							<div class="col-lg-4 col-xs-12">
								<div class="form-group">
									...
									<input onfocusout="trfrev.toAmountNumber();" id="amount" type="text" class="form-control" placeholder="Enter your amount" data-parsley-required-message="Amount required!" required>
								</div>
							</div>
							<div class="col-lg-4 col-xs-12">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-12">
								<button class="btn btn-az-secondary btn-block" onclick="trfrev.addDetailItem()"><?php echo $arrLang[$defaultLanguage]['add_detail_item']; ?></button>
							</div>
							<div class="col-12">
								<div class="table-responsive mg-t-10">
						            <table class="table table-bordered">
						              ...
						              <tbody data-bind="foreach: trfrev.data">
						                <tr>
						                  ...
						                  <td style="text-align: center">
						                  	<a style="color: red;" href="#" data-bind="click: trfrev.removeDetailItem"><i class="fa fa-trash" aria-hidden="true"></i></a>
						                  </td>
						                </tr>
						              </tbody>
						              <tfoot>
					...
					<form id="forminputmultiple">	
						<div data-bind="visible: trfrev.modeMultiple" class="row row-sm">
							<div class="col-12">
								<h2>Soon</h2>
		...
		<div data-bind="visible: trfrev.table" class="col-sm-12 col-xl-12">
			<table id="DataTableTransactionRevenue" class="display responsive nowrap">
		        <thead style="background-color: #bec1c5;">
		          <tr>
    		        ...
    		        <th class="wd-5p"><?php echo $arrLang[$defaultLanguage]['type']; ?></th>
		...
		<div data-bind="visible: trfrev.detail" class="col-xl-6">
...
<script src="dist/js/transaction_finance_revenue.js" type="text/javascript"></script>